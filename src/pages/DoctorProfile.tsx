            ...
            <main className="max-w-2xl mx-auto px-4 py-6">
                ...
                <Card className="animate-fade-in">
                    ...
                    <div className="text-center pb-6 border-b border-gray-100">
                        <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-salud-primario to-sky-400 flex items-center justify-center text-white shadow-lg overflow-hidden border-4 border-white">
                            {doctor.imagenUrl ? (
                                <img
                    ...
                    <div className="py-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                                <div className="mb-3">
                                    <p className="text-xs text-gray-400 font-medium uppercase">Credenciales</p>
                                ...
                                <div className="mb-3">
                                    <p className="text-xs text-gray-400 font-medium uppercase">Licencia Médica / Colegiado</p>
                                    <p className="text-gray-800 font-bold bg-blue-50 inline-block px-2 py-1 rounded text-sm border border-blue-100">
                                ...
                                {doctor.firmaDigitalUrl && (
                                    <div>
                                        <p className="text-xs text-gray-400 font-medium uppercase mb-1">Firma Digital Validada</p>
                                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-2 h-16 flex items-center justify-center opacity-80 hover:opacity-100 transition-opacity">
                                            <img
